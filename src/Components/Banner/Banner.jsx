    ...
    return (
        <div className='flex bg-primary rounded-lg px-6 sm:px-10 lg:px-12 my-20 md:mx-10'>
           ...
           <div className='flex-1 py-8 sm:py-10 lg:py-24 lg:pl-5'>
            ...
            <button className='bg-white text-sm sm:text-base text-gray-600 px-8 py-1 rounded-full mt-6 hover:scale-105 transition-all' onClick={()=>{navigate('/login');scrollTo(0,0)}}>Create account</button>
           </div>
           {/* right-side */}
